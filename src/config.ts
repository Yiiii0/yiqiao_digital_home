...
export const siteConfig = {
  ...
  aboutMe: {
    en: "Doing the right things rather than just doing things right. Focusing on outcomes over outputs. Embracing uncertainty. Think rationally, think long-term.",
    zh: "做正确的事，而不仅仅是把事做对。关注成果而非产出。拥抱不确定性。理性想长远。"
  },
